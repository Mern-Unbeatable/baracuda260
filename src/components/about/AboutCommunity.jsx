        ...
        <div className="flex flex-col gap-8">
          <div>
            ...
            <p className="mt-4 text-[16px] leading-normal text-[#6b7280] sm:mt-0 sm:text-[20px]">
              Our growing community consists of photographers, storytellers, hobbyists, and
              photography enthusiasts from around the world. Members can explore inspiring
              galleries, discover talented artists, participate in competitions, and celebrate each
              month&apos;s winners together.
            </p>
          </div>

          <div className="flex flex-col gap-8 sm:gap-[38px]">
            <p className="text-[16px] font-medium text-[#33333a] sm:text-[20px]">
              We believe every photograph tells a story, and every story deserves an audience.
            </p>
              ...
              {ABOUT_COMMUNITY_FEATURES.map((feature) => (
                ...
                >
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="mt-1 text-[14px] leading-normal text-[#6b7280]">{feature.text}</p>
                  </div>
                </div>
              ))}
            </div>
