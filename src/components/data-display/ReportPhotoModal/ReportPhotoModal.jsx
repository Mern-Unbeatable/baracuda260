...
const ReportPhotoModal = memo(
  ({ open, onClose, photoTitle = '', onSubmit }) => {
          ...
          <header className="border-b border-[#edf0f3] px-6 pb-5 pt-6 sm:px-8">
            <div className="flex items-start justify-between gap-4">
              <div>
                <h2
                  id={titleId}
                  className="text-[22px] font-bold leading-tight text-[#0d0d14]"
                >
                  {t('gallery.reportModal.title', {
                    defaultValue: 'Report This Photo',
                  })}
                </h2>
              ...
              <Button
                ...
                type="button"
                onClick={onClose}
                aria-label={t('gallery.reportModal.close', {
                  defaultValue: 'Close',
                })}
            ...
            <div className="min-h-0 flex-1 overflow-y-auto px-6 py-6 sm:px-8">
                        ...
                        <span className="flex flex-wrap items-center gap-2">
                          ...
                          {priority ? (
                            <span className="rounded bg-[#fee2e2] px-1.5 py-0.5 text-[10px] font-bold uppercase leading-none tracking-[0.04em] text-[#ee1c25]">
                              {t('gallery.reportModal.priorityLabel', {
              ...
              <div className="mt-6">
                <div className="mb-2 flex items-center justify-between gap-3">
                  <label
                    htmlFor={detailsId}
                    className="text-[14px] font-bold text-[#0d0d14]"
                  >
