...
const GallerySixBlueDetailContent = memo(() => {
  ...
  return (
    <div className="site-page-root gallery-six-blue-detail-page-root w-full overflow-x-hidden bg-white">
      {/* Announcement */}
      ...
      <section className="bg-white pt-8 sm:pt-10 xl:pt-12">
        <Shell>
          <div className="relative aspect-[1536/653] w-full overflow-hidden rounded-[16px] sm:rounded-[20px]">
            ...
            />
            <div className="absolute left-3 top-3 flex items-center gap-2 rounded-[20px] bg-[#4048cd] px-4 py-1 sm:left-6 sm:top-6 sm:px-5 sm:py-[5px]">
              <span className="relative inline-flex size-[28px] shrink-0 items-center justify-center overflow-hidden sm:size-[35px]">
                <img
                  ...
                  className={`object-contain ${
                    activeSlide.iconBoxed ? 'h-[18px] w-[18px] sm:h-[22px] sm:w-[22px]' : 'h-full w-full'
                  }`}
                />
              </span>
                ...
                {slides.map((slide) => (
                  ...
                  >
                    <div className="flex min-w-0 items-center gap-1.5 sm:gap-2.5">
                      <span
                        className={`relative inline-flex size-[28px] shrink-0 items-center justify-center overflow-hidden sm:size-[35px] ${
                    ...
                    <span className="inline-flex size-[26px] shrink-0 items-center justify-center rounded-full bg-[#fde8e9] text-[14px] text-[#4048cd] sm:size-[30px] sm:text-[20px]">
                      {slide.number}
                    </span>
                  </div>
                ))}
...
GallerySixBlueDetailContent.displayName = 'GallerySixBlueDetailContent';

export default GallerySixBlueDetailContent;
