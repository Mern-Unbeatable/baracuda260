...
const Input = forwardRef(
  (
    ...
    const defaultLabelClass =
      'mb-1.5 block text-[11px] font-bold uppercase tracking-wider text-[#111827]';
    ...
    return (
      <div className={className}>
        {label && (
          <label
            className={
              labelClassName !== undefined ? labelClassName : defaultLabelClass
            }
          >
            {label}
          </label>
        ...
        <input
          ...
          onInput={handleInput}
          className={
            inputClassName !== undefined ? inputClassName : defaultInputClass
          }
          {...props}
        />
        {error && (
          <p className="mt-1.5 text-[13px] text-[#ee1c25]">{error.message}</p>
        )}
      </div>
    );
  },
