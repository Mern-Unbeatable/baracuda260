...
import {
  ...
  MESSAGE_ICON_SIZE,
  QUESTION_ICON_SIZE,
} from '@/modules/admin/data/adminSupportData';
import useAdminSupport from '@/modules/admin/hooks/useAdminSupport';
  ...
  return (
    <div className="flex w-full flex-col gap-6 py-2 sm:py-4">
      <header className="flex flex-col gap-1">
        ...
        <h1 className="font-manrope pt-3 text-[28px] font-normal leading-[36px] tracking-[-1.67px] text-[#151e31] sm:text-[36px] sm:leading-[42px]">
          {t('adminSupport.title')}
        </h1>
        <p className="max-w-[40rem] pt-3 text-[15px] leading-[24px] text-[#687186] sm:text-[16px] sm:leading-[25px]">
