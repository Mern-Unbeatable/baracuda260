        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <p
                className={`text-[12px] ${isSent ? 'text-white/75' : 'text-[#6b7280]'}`}
              >
                {message.fileSize}
              </p>
            </div>
          ...
          {message.time ? (
            <p
              className={`mt-2 text-[11px] ${isSent ? 'text-white/70' : 'text-[#9ca3af]'}`}
            >
              {message.time}
            </p>
          ) : null}
      ...
      <div className="flex min-w-0 items-center gap-3">
        ...
        <div className="min-w-0">
          <div className="flex flex-wrap items-center gap-2">
            <h2 className="truncate text-[18px] font-semibold text-[#161c27]">
              {conversation.name}
            </h2>
            {conversation.online ? (
          ...
          <p className="truncate text-[13px] text-[#4048cd]">
            {conversation.handle}
          </p>
        </div>
      </div>
...
const ChatMessageArea = memo(
  ({ conversation, messages, draft, onDraftChange, onSend }) => {
    const { t } = useTranslation();
