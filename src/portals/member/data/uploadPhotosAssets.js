...
export const UPLOAD_ROUTE_SETS = {
  standalone: {
    hub: ROUTES.USER_UPLOAD_PHOTOS,
    single: ROUTES.USER_UPLOAD_SINGLE,
    story6: ROUTES.USER_UPLOAD_SIX,
    zodiac12: ROUTES.USER_UPLOAD_ZODIAC12,
  },
  artwork: {
    hub: ROUTES.USER_MY_ARTWORK_UPLOAD,
    single: ROUTES.USER_MY_ARTWORK_UPLOAD_SINGLE,
    story6: ROUTES.USER_MY_ARTWORK_UPLOAD_SIX,
    zodiac12: ROUTES.USER_MY_ARTWORK_UPLOAD_ZODIAC12,
  },
  sell: {
    hub: ROUTES.USER_SELL_PHOTOS_UPLOAD,
    single: ROUTES.USER_SELL_PHOTOS_UPLOAD_SINGLE,
    story6: ROUTES.USER_SELL_PHOTOS_UPLOAD_SIX,
    zodiac12: ROUTES.USER_SELL_PHOTOS_UPLOAD_ZODIAC12,
  },
};
