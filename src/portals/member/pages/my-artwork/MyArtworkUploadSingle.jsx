...
const MyArtworkUploadSingle = memo(() => {
  useSEO({
    title: 'Single Photo',
    description:
      'Upload a single competition photo with zodiac sign and creative details on My12Photos.',
    keywords: ['single photo', 'upload', 'zodiac', 'My12Photos'],
  });

  return (
    <SinglePhotoContent backHref={uploadHub} uploadAnotherHref={uploadHub} />
  );
});
