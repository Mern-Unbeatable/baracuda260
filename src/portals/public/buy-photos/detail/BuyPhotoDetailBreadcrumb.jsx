...
const BuyPhotoDetailBreadcrumb = memo(({ title }) => {
  const { t } = useTranslation();

  return (
    <nav
      aria-label={t('buyPhotos.detail.breadcrumb.aria')}
...
BuyPhotoDetailBreadcrumb.displayName = 'BuyPhotoDetailBreadcrumb';

export default BuyPhotoDetailBreadcrumb;
