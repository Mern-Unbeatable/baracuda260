...
const PhotographerTalentAppreciation = memo(
  ({ appreciation, photographerName, userId }) => {
        ...
        <div className="rounded-2xl border border-[#e5e7eb] bg-white p-5 sm:p-6">
          ...
          <div className="mt-5 grid grid-cols-1 gap-3 sm:grid-cols-3">
            {awards.map((tier) => {
              ...
              const disabled =
                isOwnProfile || weekly[tier.id] === 0 || tier.awardedThisWeek;
              return (
                <article
                  key={tier.id}
                ...
                >
                  ...
                  <Button
                    ...
                    title={
                      isOwnProfile
                        ? t('photographerProfile.appreciation.cannotAwardOwn')
                        : undefined
                    }
                  ...
                  >
                    {isOwnProfile
                      ? t('photographerProfile.appreciation.disabled')
                      : disabled
