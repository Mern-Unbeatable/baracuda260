...
export const ROUTES = {
  ...
  ADMIN_MY_STORE: '/admin/my-store',
  ADMIN_MY_STORE_UPLOAD: '/admin/my-store/upload',
  ADMIN_MY_STORE_EDIT: '/admin/my-store/upload/:id',
  ADMIN_FAVOURITE_PHOTOGRAPHERS: '/admin/favourite-photographers',
  ADMIN_PURCHASE_PHOTOS: '/admin/purchase-photos',
  ADMIN_MY_ORDERS: '/admin/my-orders',
  ADMIN_MY_ORDERS_DETAIL: '/admin/my-orders/:id',
...
export const SITE_NAV_LINKS = [
  ...
  { labelKey: 'nav.marketplace', href: ROUTES.MARKETPLACE },
